...
public interface TerrariumCommandApi {
    ...
    @ApiResponses(value = {
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "잘못된 요청, 아직 개화하지 않은 테라리움 등", content = @Content(schema = @Schema(implementation = ApiResponse.class))),
