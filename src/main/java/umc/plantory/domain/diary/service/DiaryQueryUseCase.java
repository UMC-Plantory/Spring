...
public interface  DiaryQueryUseCase {
    ...
    DiaryResponseDTO.DiaryExistsDTO checkTempDiaryExistence(String authorization, LocalDate date);
    DiaryResponseDTO.DiaryExistsDTO checkNormalDiaryExistence(String authorization, LocalDate date);
